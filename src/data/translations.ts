...
export const TRANSLATIONS: Record<LanguageCode, AppTranslation> = {
  ...
  en: {
    ...
    instStep1Desc: 'Tap the Download APK button on this site. The 18.4 MB official installation file will download immediately.',
    ...
    stickySub: 'Chai & snacks directly to your coach seat • 18.4 MB • Free',
    ...
    footerCtaDownload: 'Download RailSaathi APK (18.4 MB)',
  ...
  bn: {
    ...
    instStep1Desc: 'এই পেজের ডাউনলোড বোতামে চাপুন। ১৮.৪ এমবির অফিশিয়াল ফাইলটি সঙ্গে সঙ্গে ডাউনলোড হয়ে যাবে।',
    ...
    stickySub: 'সোজা আপনার বগিতে চা ও নাস্তা • ১৮.৪ এমবি • বিনামূল্যে',
    ...
    footerCtaDownload: 'রেলসাথী APK ডাউনলোড করুন (১৮.৪ এমবি)',
  ...
  hi: {
    ...
    instStep1Desc: 'इस वेबसाइट पर डाउनलोड बटन दबाएं। 18.4 एमबी की आधिकारिक फाइल तुरंत डाउनलोड हो जाएगी।',
    ...
    stickySub: 'सीधे आपकी ट्रेन सीट पर चाय और नाश्ता • 18.4 MB • मुफ्त',
    ...
    footerCtaDownload: 'रेलसाथी APK डाउनलोड करें (18.4 MB)',
  ...
  ta: {
    ...
    instStep1Desc: 'இந்த தளத்தில் உள்ள பதிவிறக்க பொத்தானை அழுத்தவும். 18.4 MB அளவிலான கோப்பு உடனடியாகப் பதிவிறங்கும்.',
    ...
    stickySub: 'நேராக உங்கள் இருக்கைக்கே டீ மற்றும் சிற்றுண்டி • 18.4 MB • இலவசம்',
    ...
    footerCtaDownload: 'ரயில்சாதி APK பதிவிறக்குக (18.4 MB)',
  ...
  ur: {
    ...
    instStep1Desc: 'اس صفحے پر موجود ڈاؤن لوڈ کے بٹن کو دبائیں۔ 18.4 ایم بی کی آفیشل فائل فوری طور پر ڈاؤن لوڈ ہو جائے گی۔',
    ...
    stickySub: 'براہ راست آپ کی سیٹ پر چائے اور ناشتہ • 18.4 MB • مفت',
    ...
    footerCtaDownload: 'ریل ساتھی APK ڈاؤن لوڈ کریں (18.4 MB)',
