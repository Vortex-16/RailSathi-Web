...
export const TRANSLATIONS: Record<LanguageCode, AppTranslation> = {
  ...
  en: {
    ...
    instStep2Desc: "Swipe down your Android phone notification shade and tap the completed 'RailSaathi.apk' file.",
  ...
  bn: {
    ...
    instStep2Desc: 'ফোনের নোটিফিকেশন বার নামিয়ে ডাউনলোড হওয়া "RailSaathi.apk" ফাইলে ট্যাপ করুন।',
  ...
  hi: {
    ...
    instStep2Desc: 'फोन का नोटिफिकेशन बार नीचे खींचें और डाउनलोड हुई "RailSaathi.apk" फाइल पर टैप करें।',
  ...
  ta: {
    ...
    instStep2Desc: 'நோட்டிபிகேஷன் பட்டியை கீழே இழுத்து "RailSaathi.apk" கோப்பைத் தட்டவும்.',
  ...
  ur: {
    ...
    instStep2Desc: 'نوٹیفکیشن بار کو نیچے کھینچیں اور مکمل ہوئی "RailSaathi.apk" فائل پر ٹیپ کریں۔',
