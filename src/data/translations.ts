...
export const TRANSLATIONS: Record<LanguageCode, AppTranslation> = {
  ...
  en: {
    ...
    heroSubheadline: 'Never miss your train just to buy a bottle of water or hot chai. RailSathi connects you directly with verified onboard vendors in your coach.',
    ...
    downloadApkBtn: '⬇️ Download RailSathi Android APK (v1.0)',
    ...
    diffHeadlinePre: 'Why RailSathi is ',
    diffHeadlinePost: 'Zepto, Blinkit, or IRCTC e-Catering',
    diffSubhead: 'Quick-commerce apps were built for motorbikes on paved city roads. Suburban local trains run on 20 to 45-second platform halts with no addresses and zero pantry cars. Here is how RailSathi solves what others cannot:',
    ...
    rsTitle: 'RailSathi (Suburban Companion)',
    ...
    vendorSubhead: 'Local train hawkers walk 12 to 18 kilometers every day carrying 15kg heavy kettles and baskets through packed crowds. RailSathi turns blind walking into guaranteed sales without taking a single rupee in commission.',
    ...
    vb3Desc: 'Instant direct payment straight from passenger to vendor. RailSathi takes zero commission, zero middleman cuts, and zero delay.',
    ...
    vendorQuote: '"Earlier I had to shout through coaches from Dadar to Thane. Often three tea sellers would cram into the exact same coach. With RailSathi, I know Coaches 4 and 7 need tea. My daily earnings increased by 35%."',
    ...
    instSubhead: 'RailSathi is distributed as a signed, open-source Android APK. It installs in under 30 seconds and requires zero intrusive permissions.',
    instBoxTitle: 'Install RailSathi in 4 Easy Steps',
    ...
    stickyTitle: 'RailSathi Android APK (v1.0.0)',
    ...
    footerCtaDownload: 'Download RailSathi APK (24.90 MB)',
